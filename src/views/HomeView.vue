  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li v-for="(navItem,i) in menuList" :key="i" class="nav-item">
        ...
        <font-awesome-icon v-if="navItem.items.length > 0" icon="fa-solid fa-angle-down" :rotation="navItem.expand ? '0':'270'" :style="{color: 'rgba(255,255,255,.5)', float:'right'}" />
        ...
        <div v-if="navItem.items.length>0" class="collapse" :class="{show: navItem.expand}">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <ul class="nav nav-sm flex-column">
                    ...
                    <a href="#" class="collapse-item">{{subItem.name}}</a>
                    </li>
                </ul>
            </div>
        </div>
